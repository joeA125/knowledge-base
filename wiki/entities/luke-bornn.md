...
A prolific contributor to spatial and [[spatiotemporal]] sports analytics, also co-authoring the defensive-structure work (Franks et al., 2015) whose defender-assignment model the EPV microtransition model builds on, and the factorised point process work (Miller et al., 2013) that informs its [[non-negative-matrix-factorization|NMF]]-based spatial bases.
...
- [[martingale-epv]] · [[expected-possession-value]] · [[pitch-control]]
- [[soccermap]] · [[probability-surface]] · [[off-ball-value]]
- [[gaussian-process]] · [[optical-tracking-data]] · [[spatiotemporal]]
- [[daniel-cervone]] · [[javier-fernandez]] · [[kirk-goldsberry]]

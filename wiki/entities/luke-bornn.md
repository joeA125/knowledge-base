...
Assistant Professor in the Department of Statistics and Actuarial Science at Simon Fraser University (at time of publication). Co-author of [[multiresolution-stochastic-process-nba-possessions|A Multiresolution Stochastic Process Model for Predicting Basketball Possession Outcomes]] (2016), which introduced [[expected-possession-value]].

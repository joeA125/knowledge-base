...
5. Any similar area claim marked "absence:" must be checked to assess any potential updates based on the new raw source, "use search_notes for 'absence:' to locate them.
